...
if __name__ == "__main__":
    ...
    parser.add_argument('cityLat', type = float, help='Lattitude of the city you live in')
    parser.add_argument('cityLon', type = float, help='Longitude of the city you live in')
